...
static	stationreaders_t	vantageproreaders[46] = {
	...
	{ "extra1.humidity", "SignedBytePacketReader", 35, 1, "%" },
	{ "extra1.humidity", "SignedBytePacketReader", 36, 1, "%" },
	{ "extra1.humidity", "SignedBytePacketReader", 37, 1, "%" },
	{ "extra1.humidity", "SignedBytePacketReader", 38, 1, "%" },
	{ "extra1.humidity", "SignedBytePacketReader", 39, 1, "%" },
	{ "extra1.humidity", "SignedBytePacketReader", 40, 1, "%" },
	{ "iss.rainrate", "RainReader", 41, 2, "in/h" },
