...
void	crc_addbyte(crc_t *crc, unsigned char c) {
...
void	crc_start(crc_t *crc) { *crc = 0; }

unsigned short	crc_stop(crc_t *crc) { return *crc; }

int	crc_cmp(crc_t *crc1, crc_t *crc2) { return *crc2 - *crc1; }
