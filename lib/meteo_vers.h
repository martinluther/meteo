...
meteo_version_t meteo_version = {
    ...
    "0.7.4",
    "0.7.4 (13-Jun-2003)",
    "This is Meteo, Version 0.7.4 (13-Jun-2003)",
    "Meteo 0.7.4 (13-Jun-2003)",
    "Meteo/0.7.4",
    "@(#)Meteo 0.7.4 (13-Jun-2003)",
    "$Id: shtool,v 1.1 2001/03/18 15:07:34 afm Exp Meteo 0.7.4 (13-Jun-2003) $"
};
