...
meteo_version_t meteo_version = {
    ...
    "0.2.0",
    "0.2.0 (14-Jan-2002)",
    "This is Meteo, Version 0.2.0 (14-Jan-2002)",
    "Meteo 0.2.0 (14-Jan-2002)",
    "Meteo/0.2.0",
    "@(#)Meteo 0.2.0 (14-Jan-2002)",
    "$Id: shtool,v 1.1 2001/03/18 15:07:34 afm Exp Meteo 0.2.0 (14-Jan-2002) $"
};
