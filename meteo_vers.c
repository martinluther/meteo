...
meteo_version_t meteo_version = {
    ...
    "0.1.6",
    "0.1.6 (29-Dec-2001)",
    "This is Meteo, Version 0.1.6 (29-Dec-2001)",
    "Meteo 0.1.6 (29-Dec-2001)",
    "Meteo/0.1.6",
    "@(#)Meteo 0.1.6 (29-Dec-2001)",
    "$Id: shtool,v 1.1 2001/03/18 15:07:34 afm Exp Meteo 0.1.6 (29-Dec-2001) $"
};
