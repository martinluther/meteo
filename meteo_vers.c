...
meteo_version_t meteo_version = {
    ...
    "0.1.9",
    "0.1.9 (11-Jan-2002)",
    "This is Meteo, Version 0.1.9 (11-Jan-2002)",
    "Meteo 0.1.9 (11-Jan-2002)",
    "Meteo/0.1.9",
    "@(#)Meteo 0.1.9 (11-Jan-2002)",
    "$Id: shtool,v 1.1 2001/03/18 15:07:34 afm Exp Meteo 0.1.9 (11-Jan-2002) $"
};
