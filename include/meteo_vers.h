...
meteo_version_t meteo_version = {
    ...
    "0.9.8",
    "0.9.8 (01-Mar-2004)",
    "This is Meteo, Version 0.9.8 (01-Mar-2004)",
    "Meteo 0.9.8 (01-Mar-2004)",
    "Meteo/0.9.8",
    "@(#)Meteo 0.9.8 (01-Mar-2004)",
    "$Id: shtool,v 1.1 2001/03/18 15:07:34 afm Exp Meteo 0.9.8 (01-Mar-2004) $"
};
