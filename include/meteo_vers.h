...
meteo_version_t meteo_version = {
    ...
    "0.9.2",
    "0.9.2 (11-Nov-2003)",
    "This is Meteo, Version 0.9.2 (11-Nov-2003)",
    "Meteo 0.9.2 (11-Nov-2003)",
    "Meteo/0.9.2",
    "@(#)Meteo 0.9.2 (11-Nov-2003)",
    "$Id: shtool,v 1.1 2001/03/18 15:07:34 afm Exp Meteo 0.9.2 (11-Nov-2003) $"
};
